 <!-- footer content -->
    ...
    <script src="{{ asset('asset') }}/vendors/datatables.net/js/jquery.dataTables.js" crossorigin="anonymous"></script>
    <script src="{{ asset('asset') }}/vendors/datatables.net/js/jquery.dataTables.min.js" crossorigin="anonymous"></script>
 @stack('script')
