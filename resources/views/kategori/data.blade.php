        ...
        @foreach ($kategori as $p)
            <tr>
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal"
                        ...
                        data-nama_kategori="{{ $p->nama_kategori}}">
                    ...
                    <form action="{{ route('kategori.destroy', $p->id) }}" method="POST" class="d-inline form-delete"
                        ...
                        @csrf
                        @method('DELETE')   
                            <button type="submit" class="btn btn-danger delete-data" data-id="{{ $p->id}}" data-nama_kategori="{{ $p->nama_kategori}}">
...
@push('script')
    ...
    <script>
        $(function() {
            ...
            }).buttons().container().appendTo('#data-kategori .col-md-6:eq(0)');
            $('#example2').DataTable({
                "paging": true,
                "lengthChange": false,
                "searching": false,
