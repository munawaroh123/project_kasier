                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <div class="dropdown-jenis" aria-labelledby="dropdownJenisButton">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                        data-target="#formJenisModal" data-mode="edit" data-id="{{ $p->id }}"
                        data-id="{{ $p->id}}"
                        data-nama_jenis="{{ $p->nama_jenis}}"> Ubah
                        <i class='fa fa-edit'></i>
                    </button>
                    <form action="{{ route('jenis.destroy', $p->id) }}" method="POST" class="d-inline form-delete"
                        style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger delete-data"
                        data-id="{{ $p->id}}"
                        data-nama_jenis="{{ $p->nama_jenis}}">Hapus
